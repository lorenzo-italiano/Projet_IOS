...
class FestivalDAO: DAO<Festival> {
    ...
    public func getNbVolunteersTimeslot(id: String) async throws -> String {
        ...
        guard let url = URL(string:"https://europe-west1-projetios-backend.cloudfunctions.net/app/api/v1/timeslots/" + id + "/nbVolunteers") else {
            throw RequestError.serverError
        }
    ...
    public func getMaxCapacityTimeslot(id: String) async throws -> String {
        ...
        guard let url = URL(string:"https://europe-west1-projetios-backend.cloudfunctions.net/app/api/v1/timeslots/" + id + "/max") else {
            throw RequestError.serverError
        }
